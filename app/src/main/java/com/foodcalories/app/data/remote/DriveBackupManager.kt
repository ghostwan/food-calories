...
class DriveBackupManager(private val context: Context) {
    ...
    private fun getDriveService(): Drive? {
        ...
        return Drive.Builder(
            ...
            .setApplicationName("Food Calories")
            .build()
    }
    ...
    private fun jsonToProfile(json: JSONObject) = UserProfile(
        ...
        age = json.getInt("age"),
        gender = com.foodcalories.app.domain.model.Gender.valueOf(json.getString("gender")),
        activityLevel = com.foodcalories.app.domain.model.ActivityLevel.valueOf(json.getString("activityLevel"))
    )
