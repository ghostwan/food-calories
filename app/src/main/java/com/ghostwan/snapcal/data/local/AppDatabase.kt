...
@Database(entities = [MealEntity::class, WeightEntity::class, ShoppingItemEntity::class, DailyNoteEntity::class, BodyMeasurementEntity::class], version = 9, exportSchema = false)
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_8_9 = object : Migration(8, 9) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE meals ADD COLUMN mealType TEXT")
            }
        }
